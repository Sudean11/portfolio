      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                ...
                <a
                  href="https://www.linkedin.com/posts/vedpatel-33_microservices-springboot-fastapi-activity-7218494441941086208-vtv5?utm_source=share&utm_medium=member_desktop"
                  target="_blank"
                  rel="noreferrer">
                  <img
                    src={externalLink}
            ...
            <div className="body">
              <h3>Document Chatting Application</h3>
              <p>
                This innovative project revolutionizes how we interact with
                documents by enabling intelligent, real-time conversations. By
                leveraging a robust microservice architecture, state-of-the-art
                AI, and modern frontend technologies, this project aims to
                provide instant answers and enhance user experience.
              </p>
              <p>
                Microservice Architecture: Utilized Spring Boot for client
                interactions and FastAPI for OpenAI integration.
              </p>
              <p>
                AI Integration: Enabled smart, context-aware conversations with
                documents using OpenAI Assistants, and vector stores.
              </p>
            </div>
            <footer>
              {" "}
              <ul className="tech-list">
                {" "}
                <li>Spring Boot</li> <li>FastAPI</li> <li>OpenAI</li>{" "}
                <li>Angular17</li>{" "}
              </ul>{" "}
            </footer>
          </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Job Application Tracking Telegram Bot</h3>
              <p>
                Developed a Telegram bot integrated with Google Sheets to
                automate LinkedIn job tracking using Selenium, improving data
                accuracy by 60% and reducing manual data entry by 20 hours
                monthly.
              </p>
              <p>
                Selenium Automation: Scraped Data LinkedIn job postings and
                tracked application statuses, automating data entry into Google
                Sheets. Save the job description as a PDF file.
              </p>
              <p>
                Filters the Technical skills, Soft SKiils, any email address,
                and phone number from the job description and saves in the
                Google Sheet.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>ChatGPT Integreted Telegram Bot</h3>
              <p>
                Integrated OpenAI's ChatGPT with Telegram bot to provide instant
                answers to user queries, enhancing user engagement and
                experience. Added different agents for different tasks.
              </p>
              <p>
                Image Generation and Voice interaction using OpenAI's DALL-E and
                GPT-4 models.
              </p>
              <p>Payment Integration using Stripe API, Coinbase.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Python</li>
